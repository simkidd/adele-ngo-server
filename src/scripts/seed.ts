...
const MONGODB_URI =
  process.env.MONGODB_URI ?? "mongodb://localhost:27017/adele-foundation";
...
const programs = [
  // Construction & Civil Works
  {
    ...
    description:
      "Comprehensive training in domestic, commercial and industrial electrical wiring, installation, and safety standards. Graduates are equipped to work on building projects or start electrical contracting businesses.",
    objectives: [
  ...
  },
  {
    ...
    category: "Construction & Civil Works",
    description:
      "Hands-on training in water supply, drainage systems, sanitation installations, and gas pipe-fitting for residential and commercial buildings.",
    objectives: [
  ...
  },
  {
    ...
    category: "Construction & Civil Works",
    description:
      "Masonry skills training covering block laying, brick work, concrete mixing and pouring, foundation construction and finishing.",
    objectives: [
  ...
  },
  {
    ...
    category: "Construction & Civil Works",
    description:
      "Training in ceramic, porcelain and granite tile installation, floor cladding, interlocking paving and finishing techniques for residential and commercial spaces.",
    objectives: [
  ...
  },
  {
    ...
    category: "Construction & Civil Works",
    description:
      "Professional painting and decorating training covering surface preparation, colour theory, interior design principles, and finishing techniques for residential and commercial spaces.",
    objectives: [
  ...
  // Fabrication & Metalwork
  {
    ...
    description:
      "Technical training in arc welding, MIG/TIG welding, metal cutting, fabrication and structural steel work. Graduates work in construction, manufacturing and start their own fabrication workshops.",
    objectives: [
  ...
  },
  {
    ...
    category: "Fabrication & Metalwork",
    description:
      "Training in vehicle body repair, panel beating, dent removal, rust treatment and automotive finishing. Graduates work in vehicle workshops or establish their own auto-body shops.",
    objectives: [
  ...
  },
  {
    ...
    category: "Fabrication & Metalwork",
    description:
      "Traditional and modern blacksmithing skills including forging, metal shaping, ornamental ironwork and tool making. Covers both traditional craft and modern applications.",
    objectives: [
  ...
  // Woodwork & Furniture
  {
    ...
    description:
      "Comprehensive woodwork training covering hand and power tools, joinery, construction carpentry, roofing and site work. Graduates work in construction or establish workshops.",
    objectives: [
  ...
  },
  {
    ...
    category: "Woodwork & Furniture",
    description:
      "Design and production of custom furniture, cabinet making, wood finishing and upholstery. Graduates supply the high-demand residential and commercial furniture market.",
    objectives: [
  ...
  // Automotive & Mechanical
  {
    ...
    description:
      "Comprehensive auto mechanics training covering engine diagnostics, transmission, brakes, suspension and modern vehicle systems. Graduates work in workshops or establish their own.",
    objectives: [
  ...
  },
  {
    ...
    category: "Automotive & Mechanical",
    description:
      "Specialised training in motorcycle and Keke Napep tricycle mechanics, covering engine repair, electrical systems and chassis maintenance.",
    objectives: [
  ...
  },
  {
    ...
    category: "Automotive & Mechanical",
    description:
      "Training in tire repair, retreading, wheel balancing, alignment and vulcanising for all vehicle types. Low startup cost with high demand in Nigerian transport sector.",
    objectives: [
  ...
  },
  {
    ...
    category: "Automotive & Mechanical",
    description:
      "Technical training in the installation, servicing and repair of domestic refrigerators, chest freezers, split-unit and window air conditioners.",
    objectives: [
  ...
  },
  {
    ...
    category: "Automotive & Mechanical",
    description:
      "Training in solar panel installation, battery storage systems, inverter setup and maintenance. One of the fastest-growing skills in Nigeria due to power supply challenges.",
    objectives: [
  ...
  },
  {
    ...
    category: "Automotive & Mechanical",
    description:
      "Specialised training in converting petrol vehicles to Compressed Natural Gas (CNG) and maintaining CNG systems — a critical skill as Nigeria transitions to gas-powered transport.",
    objectives: [
  ...
  },
  {
    ...
    category: "Automotive & Mechanical",
    description:
      "Training in the operation and maintenance of agricultural machinery including tractors, tillers, harvesters and irrigation pumps.",
    objectives: [
  ...
  // Technology & Networks
  {
    ...
    description:
      "Training in structured cabling, LAN/WAN network installation, Wi-Fi setup, CCTV and access control systems for commercial and residential buildings.",
    objectives: [
  ...
  },
  {
    ...
    category: "Technology & Networks",
    description:
      "Practical training in laptop/desktop hardware repair, motherboard-level diagnostics, mobile phone repairs, and software installation.",
    objectives: [
  ...
  },
  {
    ...
    category: "Technology & Networks",
    description:
      "Training in photography, videography, video editing, graphic design and social media content creation for business and personal brand purposes.",
    objectives: [
  ...
  // Media & Communications
  {
    ...
    description:
      "Training in social media strategy, content creation, community management, paid advertising and personal branding for businesses and individuals.",
    objectives: [
  ...
  // Agriculture
  {
    ...
    description:
      "Training in poultry management, pig and goat farming, bee keeping and general animal husbandry for commercial production.",
    objectives: [
  ...
  // Fashion & Beauty
  {
    ...
    description:
      "Training in pattern making, garment construction, fashion illustration, fabric selection and the business of fashion — with a focus on both African fashion and ready-to-wear.",
    objectives: [
  ...
  },
  {
    ...
    category: "Fashion & Beauty",
    description:
      "Professional training in hair styling, braiding, locs, makeup artistry, skincare, manicure, pedicure and salon management.",
    objectives: [
  ...
  // Hospitality
  {
    ...
    description:
      "Training in food and beverage service, hotel front office operations, housekeeping, catering and event management for the hospitality industry.",
    objectives: [
...
const centers = [
  {
    ...
    state: "Rivers State",
    address:
      "Adele Foundation Complex, Trans-Amadi Industrial Layout, Port Harcourt, Rivers State",
  ...
  },
  {
    ...
    state: "Bayelsa State",
    address:
      "Adele Foundation Annex, Swali Market Road, Yenagoa, Bayelsa State",
...
async function seed() {
  ...
  await mongoose.connect(MONGODB_URI, { dbName: "adele-foundation" });
  ...
  const createdPrograms = await Program.insertMany(
    programs.map((p) => ({
      ...p,
      slug: p.title
        .toLowerCase()
  ...
  await Center.updateMany({}, { programs: allProgramIds });
  ...
  for (const center of createdCenters) {
    ...
    console.log(
      `   ✅ officer.${center.code.toLowerCase()}@adelefoundation.org / Officer2025!`,
    );
  }
